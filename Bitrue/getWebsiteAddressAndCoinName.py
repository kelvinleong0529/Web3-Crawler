...
def bitrueGetWebsiteAddressAndCoinName(tokenSymbol, maxRetries=6) -> Tuple[str,str]:
    ...
    while retries < maxRetries:
        try:
            ...
            officialWebsiteAddress = response["data"]["coinInfo"]["baseInfo"]["website"]
            break
        except:
            coinName = 0
            officialWebsiteAddress = 0
            retries += 1

    return (str(officialWebsiteAddress),str(coinName))
